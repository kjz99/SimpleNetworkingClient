...
/// </remarks>
public class SerilogLogger(ILogger logger) : ISimpleNetworkingClientLogger
{
    ...
    /// </summary>
    public void Warn(string message, Exception ex = default)
        => _logger.Warning(ex, message);

    /// <summary>
    /// Logs an error message to the configured logger
    /// </summary>
    ...
    /// </summary>
    public void Fatal(string message, Exception ex = default)
